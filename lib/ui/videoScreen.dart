...
final Directory _oldVideoDir = Directory(
...
class VideoScreenState extends State<VideoScreen> {
  ...
  Widget build(BuildContext context) {
    if (!Directory('${_videoDir.path}').existsSync() && !Directory('${_oldVideoDir.path}').existsSync()) {
      return Column(
      ...
      if(!Directory('${_videoDir.path}').existsSync()) {
        return VideoGrid(directory: _oldVideoDir);
      } else {
